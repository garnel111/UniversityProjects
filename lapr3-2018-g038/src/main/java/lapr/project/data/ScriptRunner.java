...
public class ScriptRunner {
    ...
    public ScriptRunner(Connection connection, boolean autoCommit,
        ...
        try {
            if (logFile.exists()) {
                f1 = new FileWriter(logFile, true);
                logWriter = new PrintWriter(f1);
            } else {
                f2 = new FileWriter(logFile, true);
                logWriter = new PrintWriter(f2);
            }
        } catch (IOException e) {
        ...
        try {
            if (errorLogFile.exists()) {
                e1 = new FileWriter(errorLogFile, true);
                errorLogWriter = new PrintWriter(e1);
            } else {
                e2 = new FileWriter(errorLogFile, true);
                errorLogWriter = new PrintWriter(e2);
            }
        } catch (IOException e) {
